...
/**
 * Class _Sunrise_Forms
 */
class _Sunrise_Forms extends Sunrise_Base {
	...
	static function get_forms( $form_args = array() ) {
		$form_args = self::normalize_form_args( $form_args );
	...
	/**
	 * Add a prefix to a form $arg if needed based on the property names of the class.
	 *
	 * @param string $form_name
	 * @return string
	 */
	private static function _maybe_prefix_form_arg( $form_name ) {
		return Sunrise::maybe_prefix_class_arg( $form_name, 'form_', 'Sunrise_Form_Base' );
	}
